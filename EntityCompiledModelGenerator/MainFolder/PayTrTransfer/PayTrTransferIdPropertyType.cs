...
{
    public class PayTrTransferIdPropertyType:IProperty
    {
        private static PayTrTransferIdPropertyType _instance;
        public static PayTrTransferIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PayTrTransferIdPropertyType();
            }
            return _instance;
        }
        ...
        public PayTrTransferIdPropertyType ()
        {
        }
        ...
        public string Name =>"PayTrTransferId";
