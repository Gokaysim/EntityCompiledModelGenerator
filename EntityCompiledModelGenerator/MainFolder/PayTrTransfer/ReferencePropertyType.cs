...
{
    public class ReferencePropertyType:IProperty
    {
        private static ReferencePropertyType _instance;
        public static ReferencePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ReferencePropertyType();
            }
            return _instance;
        }
