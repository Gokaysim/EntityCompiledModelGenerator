...
{
    public class PayTrPaymentIdPropertyType:IProperty
    {
        private static PayTrPaymentIdPropertyType _instance;
        public static PayTrPaymentIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PayTrPaymentIdPropertyType();
            }
            return _instance;
        }
        ...
        public PayTrPaymentIdPropertyType ()
        {
        }
        ...
        public string Name =>"PayTrPaymentId";
