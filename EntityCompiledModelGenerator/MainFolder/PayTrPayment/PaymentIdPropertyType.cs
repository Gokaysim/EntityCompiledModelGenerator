...
{
    public class PaymentIdPropertyType:IProperty
    {
        private static PaymentIdPropertyType _instance;
        public static PaymentIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PaymentIdPropertyType();
            }
            return _instance;
        }
