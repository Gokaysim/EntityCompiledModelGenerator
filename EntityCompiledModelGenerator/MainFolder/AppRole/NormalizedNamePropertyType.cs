...
{
    public class NormalizedNamePropertyType:IProperty
    {
        private static NormalizedNamePropertyType _instance;
        public static NormalizedNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new NormalizedNamePropertyType();
            }
            return _instance;
        }
        ...
        public NormalizedNamePropertyType ()
        {
        }
