...
{
    public class ConcurrencyStampPropertyType:IProperty
    {
        private static ConcurrencyStampPropertyType _instance;
        public static ConcurrencyStampPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ConcurrencyStampPropertyType();
            }
            return _instance;
        }
        ...
        public ConcurrencyStampPropertyType ()
        {
        }
        ...
        public string Name =>"ConcurrencyStamp";
        public ITypeBase DeclaringType => AppRoleEntityType.GetInstance();
