...
{
    public class RoleIdPropertyType:IProperty
    {
        private static RoleIdPropertyType _instance;
        public static RoleIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new RoleIdPropertyType();
            }
            return _instance;
        }
