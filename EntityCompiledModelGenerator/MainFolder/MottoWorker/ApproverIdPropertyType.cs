...
{
    public class ApproverIdPropertyType:IProperty
    {
        private static ApproverIdPropertyType _instance;
        public static ApproverIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ApproverIdPropertyType();
            }
            return _instance;
        }
