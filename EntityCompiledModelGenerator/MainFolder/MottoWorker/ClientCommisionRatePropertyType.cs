...
{
    public class ClientCommisionRatePropertyType:IProperty
    {
        private static ClientCommisionRatePropertyType _instance;
        public static ClientCommisionRatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ClientCommisionRatePropertyType();
            }
            return _instance;
        }
        ...
        public ClientCommisionRatePropertyType ()
        {
        }
        ...
        public string Name =>"ClientCommisionRate";
