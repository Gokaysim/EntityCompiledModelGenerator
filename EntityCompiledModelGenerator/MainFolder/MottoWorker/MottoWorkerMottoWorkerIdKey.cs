...
{
    public class MottoWorkerMottoWorkerIdKey:IKey
    {    
        private static MottoWorkerMottoWorkerIdKey _instance;            
        public static MottoWorkerMottoWorkerIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new MottoWorkerMottoWorkerIdKey();
            }
            return _instance;
        }
