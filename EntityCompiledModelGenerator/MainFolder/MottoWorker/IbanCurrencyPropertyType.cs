...
{
    public class IbanCurrencyPropertyType:IProperty
    {
        private static IbanCurrencyPropertyType _instance;
        public static IbanCurrencyPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new IbanCurrencyPropertyType();
            }
            return _instance;
        }
        ...
        public IbanCurrencyPropertyType ()
        {
        }
        ...
        public string Name =>"IbanCurrency";
