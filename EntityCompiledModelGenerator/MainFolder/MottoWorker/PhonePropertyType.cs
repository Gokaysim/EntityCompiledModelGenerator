...
{
    public class PhonePropertyType:IProperty
    {
        private static PhonePropertyType _instance;
        public static PhonePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PhonePropertyType();
            }
            return _instance;
        }
