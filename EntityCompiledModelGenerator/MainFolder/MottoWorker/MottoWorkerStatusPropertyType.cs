...
{
    public class MottoWorkerStatusPropertyType:IProperty
    {
        private static MottoWorkerStatusPropertyType _instance;
        public static MottoWorkerStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MottoWorkerStatusPropertyType();
            }
            return _instance;
        }
        ...
        public MottoWorkerStatusPropertyType ()
        {
        }
        ...
        public string Name =>"MottoWorkerStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.MottoWorkDBO.MottoWorkerStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.MottoWorkDBO.MottoWorkerStatus);
                }
                return _clrType;
            }
        }
