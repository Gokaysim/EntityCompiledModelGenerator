...
{
    public class IbanPropertyType:IProperty
    {
        private static IbanPropertyType _instance;
        public static IbanPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new IbanPropertyType();
            }
            return _instance;
        }
