...
{
    public class MottoWorkerCommisionRatePropertyType:IProperty
    {
        private static MottoWorkerCommisionRatePropertyType _instance;
        public static MottoWorkerCommisionRatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MottoWorkerCommisionRatePropertyType();
            }
            return _instance;
        }
        ...
        public MottoWorkerCommisionRatePropertyType ()
        {
        }
        ...
        public string Name =>"MottoWorkerCommisionRate";
