...
{
    public class IbanNamePropertyType:IProperty
    {
        private static IbanNamePropertyType _instance;
        public static IbanNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new IbanNamePropertyType();
            }
            return _instance;
        }
