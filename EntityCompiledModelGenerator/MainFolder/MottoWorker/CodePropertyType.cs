...
{
    public class CodePropertyType:IProperty
    {
        private static CodePropertyType _instance;
        public static CodePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CodePropertyType();
            }
            return _instance;
        }
