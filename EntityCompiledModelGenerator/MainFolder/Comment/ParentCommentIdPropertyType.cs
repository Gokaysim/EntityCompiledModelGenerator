...
{
    public class ParentCommentIdPropertyType:IProperty
    {
        private static ParentCommentIdPropertyType _instance;
        public static ParentCommentIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ParentCommentIdPropertyType();
            }
            return _instance;
        }
        ...
        public ParentCommentIdPropertyType ()
        {
        }
        ...
        public string Name =>"ParentCommentId";
