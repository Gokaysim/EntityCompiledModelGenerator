...
{
    public class CommentIdPropertyType:IProperty
    {
        private static CommentIdPropertyType _instance;
        public static CommentIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CommentIdPropertyType();
            }
            return _instance;
        }
