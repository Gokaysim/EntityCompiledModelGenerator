...
{
    public class CommentTextPropertyType:IProperty
    {
        private static CommentTextPropertyType _instance;
        public static CommentTextPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CommentTextPropertyType();
            }
            return _instance;
        }
        ...
        public CommentTextPropertyType ()
        {
        }
        ...
        public string Name =>"CommentText";
