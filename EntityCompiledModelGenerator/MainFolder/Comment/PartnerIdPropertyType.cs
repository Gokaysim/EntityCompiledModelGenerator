...
{
    public class PartnerIdPropertyType:IProperty
    {
        private static PartnerIdPropertyType _instance;
        public static PartnerIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PartnerIdPropertyType();
            }
            return _instance;
        }
