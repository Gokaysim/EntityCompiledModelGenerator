...
{
    public class RateIdPropertyType:IProperty
    {
        private static RateIdPropertyType _instance;
        public static RateIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new RateIdPropertyType();
            }
            return _instance;
        }
