...
{
    public class CommentStatusPropertyType:IProperty
    {
        private static CommentStatusPropertyType _instance;
        public static CommentStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CommentStatusPropertyType();
            }
            return _instance;
        }
        ...
        public CommentStatusPropertyType ()
        {
        }
        ...
        public string Name =>"CommentStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.EvaluationDBO.CommentStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.EvaluationDBO.CommentStatus);
                }
                return _clrType;
            }
        }
