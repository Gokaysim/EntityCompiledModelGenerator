...
{
  public class ParentCommentIdIndex : IIndex
  {
  
    private static ParentCommentIdIndex _instance;
    
    public static ParentCommentIdIndex GetInstance()
    {
        if(_instance==null)
        {
            _instance = new ParentCommentIdIndex();
        }
        return _instance;
    }
