...
{
    public class ClientIdPropertyType:IProperty
    {
        private static ClientIdPropertyType _instance;
        public static ClientIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ClientIdPropertyType();
            }
            return _instance;
        }
