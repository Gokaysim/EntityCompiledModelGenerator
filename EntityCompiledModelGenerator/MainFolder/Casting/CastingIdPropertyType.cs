...
{
    public class CastingIdPropertyType:IProperty
    {
        private static CastingIdPropertyType _instance;
        public static CastingIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CastingIdPropertyType();
            }
            return _instance;
        }
