...
{
    public class PartnerStatusPropertyType:IProperty
    {
        private static PartnerStatusPropertyType _instance;
        public static PartnerStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PartnerStatusPropertyType();
            }
            return _instance;
        }
        ...
        public PartnerStatusPropertyType ()
        {
        }
        ...
        public string Name =>"PartnerStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.PartnerDBO.PartnerStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.PartnerDBO.PartnerStatus);
                }
                return _clrType;
            }
        }
