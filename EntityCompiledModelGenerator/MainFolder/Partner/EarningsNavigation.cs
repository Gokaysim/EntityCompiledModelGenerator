    ...
    public class EarningsNavigation:INavigation
    {
        ...
        public Type ClrType { 
            get
            {
                if(clrType==null)
                {
                    clrType = Type.GetType("System.Collections.Generic.IEnumerable`1[[Mottojoy.Infrastructure.Entity.FinancialDBO.Earning, Mottojoy.Infrastructure.Entity, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]");
                }
                return clrType;
            } 
        }
        ...
        public IForeignKey ForeignKey => EarningPartnerIdForeignKey.GetInstance();
