...
{
    public class PartnerPartnerIdKey:IKey
    {    
        private static PartnerPartnerIdKey _instance;            
        public static PartnerPartnerIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new PartnerPartnerIdKey();
            }
            return _instance;
        }
