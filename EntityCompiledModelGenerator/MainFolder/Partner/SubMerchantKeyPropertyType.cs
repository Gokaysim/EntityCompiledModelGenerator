...
{
    public class SubMerchantKeyPropertyType:IProperty
    {
        private static SubMerchantKeyPropertyType _instance;
        public static SubMerchantKeyPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new SubMerchantKeyPropertyType();
            }
            return _instance;
        }
        ...
        public SubMerchantKeyPropertyType ()
        {
        }
        ...
        public string Name =>"SubMerchantKey";
