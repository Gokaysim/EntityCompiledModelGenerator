...
{
    public class PartnerPhoneIdPropertyType:IProperty
    {
        private static PartnerPhoneIdPropertyType _instance;
        public static PartnerPhoneIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PartnerPhoneIdPropertyType();
            }
            return _instance;
        }
        ...
        public PartnerPhoneIdPropertyType ()
        {
        }
        ...
        public string Name =>"PartnerPhoneId";
