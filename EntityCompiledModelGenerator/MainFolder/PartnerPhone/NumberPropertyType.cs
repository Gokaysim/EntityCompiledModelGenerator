...
{
    public class NumberPropertyType:IProperty
    {
        private static NumberPropertyType _instance;
        public static NumberPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new NumberPropertyType();
            }
            return _instance;
        }
