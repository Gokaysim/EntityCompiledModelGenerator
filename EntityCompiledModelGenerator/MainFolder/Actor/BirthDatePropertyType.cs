...
{
    public class BirthDatePropertyType:IProperty
    {
        private static BirthDatePropertyType _instance;
        public static BirthDatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new BirthDatePropertyType();
            }
            return _instance;
        }
