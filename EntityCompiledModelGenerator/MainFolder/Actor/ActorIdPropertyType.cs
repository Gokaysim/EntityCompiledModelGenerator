...
{
    public class ActorIdPropertyType:IProperty
    {
        private static ActorIdPropertyType _instance;
        public static ActorIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ActorIdPropertyType();
            }
            return _instance;
        }
