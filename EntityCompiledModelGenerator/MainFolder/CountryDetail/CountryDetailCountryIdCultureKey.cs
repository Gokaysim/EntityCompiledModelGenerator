...
{
    public class CountryDetailCountryIdCultureKey:IKey
    {    
        private static CountryDetailCountryIdCultureKey _instance;            
        public static CountryDetailCountryIdCultureKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new CountryDetailCountryIdCultureKey();
            }
            return _instance;
        }
