...
{
    public class TourIdPropertyType:IProperty
    {
        private static TourIdPropertyType _instance;
        public static TourIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourIdPropertyType();
            }
            return _instance;
        }
        
        private bool _isShadowProperty = true;
        private bool _isShadowProperty1 = true;
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = Type.GetType("System.Nullable`1[[System.Int32, System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]");
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = Type.GetType("System.Nullable`1[[System.Int32, System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]");
                }
                return _clrType;
            }
        }
