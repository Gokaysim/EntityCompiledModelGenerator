...
{
    public class PointPropertyType:IProperty
    {
        private static PointPropertyType _instance;
        public static PointPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PointPropertyType();
            }
            return _instance;
        }
