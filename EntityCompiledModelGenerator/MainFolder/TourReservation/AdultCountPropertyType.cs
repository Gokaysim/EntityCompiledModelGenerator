...
{
    public class AdultCountPropertyType:IProperty
    {
        private static AdultCountPropertyType _instance;
        public static AdultCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultCountPropertyType();
            }
            return _instance;
        }
