...
{
    public class TotalTourExtraPricePropertyType:IProperty
    {
        private static TotalTourExtraPricePropertyType _instance;
        public static TotalTourExtraPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TotalTourExtraPricePropertyType();
            }
            return _instance;
        }
        ...
        public TotalTourExtraPricePropertyType ()
        {
        }
        ...
        public string Name =>"TotalTourExtraPrice";
