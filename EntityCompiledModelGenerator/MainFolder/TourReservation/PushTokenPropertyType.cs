...
{
    public class PushTokenPropertyType:IProperty
    {
        private static PushTokenPropertyType _instance;
        public static PushTokenPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PushTokenPropertyType();
            }
            return _instance;
        }
