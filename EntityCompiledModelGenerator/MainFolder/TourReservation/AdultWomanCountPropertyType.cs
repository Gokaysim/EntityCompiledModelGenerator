...
{
    public class AdultWomanCountPropertyType:IProperty
    {
        private static AdultWomanCountPropertyType _instance;
        public static AdultWomanCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultWomanCountPropertyType();
            }
            return _instance;
        }
        ...
        public AdultWomanCountPropertyType ()
        {
        }
        ...
        public string Name =>"AdultWomanCount";
