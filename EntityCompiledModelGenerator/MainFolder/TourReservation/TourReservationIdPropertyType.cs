...
{
    public class TourReservationIdPropertyType:IProperty
    {
        private static TourReservationIdPropertyType _instance;
        public static TourReservationIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourReservationIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourReservationIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourReservationId";
