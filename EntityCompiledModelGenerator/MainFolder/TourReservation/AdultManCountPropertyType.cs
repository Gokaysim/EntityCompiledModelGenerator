...
{
    public class AdultManCountPropertyType:IProperty
    {
        private static AdultManCountPropertyType _instance;
        public static AdultManCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultManCountPropertyType();
            }
            return _instance;
        }
        ...
        public AdultManCountPropertyType ()
        {
        }
        ...
        public string Name =>"AdultManCount";
