...
{
  public class ReservationIdIndex : IIndex
  {
  
    private static ReservationIdIndex _instance;
    
    public static ReservationIdIndex GetInstance()
    {
        if(_instance==null)
        {
            _instance = new ReservationIdIndex();
        }
        return _instance;
    }
