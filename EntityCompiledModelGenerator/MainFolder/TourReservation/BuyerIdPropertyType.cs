...
{
    public class BuyerIdPropertyType:IProperty
    {
        private static BuyerIdPropertyType _instance;
        public static BuyerIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new BuyerIdPropertyType();
            }
            return _instance;
        }
