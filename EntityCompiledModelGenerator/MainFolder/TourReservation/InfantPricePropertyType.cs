...
{
    public class InfantPricePropertyType:IProperty
    {
        private static InfantPricePropertyType _instance;
        public static InfantPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InfantPricePropertyType();
            }
            return _instance;
        }
        ...
        public InfantPricePropertyType ()
        {
        }
        ...
        public string Name =>"InfantPrice";
