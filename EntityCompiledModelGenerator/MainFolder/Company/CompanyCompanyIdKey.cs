...
{
    public class CompanyCompanyIdKey:IKey
    {    
        private static CompanyCompanyIdKey _instance;            
        public static CompanyCompanyIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new CompanyCompanyIdKey();
            }
            return _instance;
        }
