...
{
    public class PaymentSytemPropertyType:IProperty
    {
        private static PaymentSytemPropertyType _instance;
        public static PaymentSytemPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PaymentSytemPropertyType();
            }
            return _instance;
        }
        ...
        public PaymentSytemPropertyType ()
        {
        }
        ...
        public string Name =>"PaymentSytem";
