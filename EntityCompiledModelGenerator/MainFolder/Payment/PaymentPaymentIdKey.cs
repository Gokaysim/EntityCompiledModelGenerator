...
{
    public class PaymentPaymentIdKey:IKey
    {    
        private static PaymentPaymentIdKey _instance;            
        public static PaymentPaymentIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new PaymentPaymentIdKey();
            }
            return _instance;
        }
