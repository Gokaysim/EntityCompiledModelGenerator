...
{
    public class PNRCodePropertyType:IProperty
    {
        private static PNRCodePropertyType _instance;
        public static PNRCodePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PNRCodePropertyType();
            }
            return _instance;
        }
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = Type.GetType("System.Guid");
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = Type.GetType("System.Guid");
                }
                return _clrType;
            }
        }
