...
{
    public class StatusPropertyType:IProperty
    {
        private static StatusPropertyType _instance;
        public static StatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new StatusPropertyType();
            }
            return _instance;
        }
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.PaymentStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.PaymentStatus);
                }
                return _clrType;
            }
        }
