...
{
    public class CurrencyPropertyType:IProperty
    {
        private static CurrencyPropertyType _instance;
        public static CurrencyPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CurrencyPropertyType();
            }
            return _instance;
        }
