...
{
    public class MovieNamePropertyType:IProperty
    {
        private static MovieNamePropertyType _instance;
        public static MovieNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MovieNamePropertyType();
            }
            return _instance;
        }
