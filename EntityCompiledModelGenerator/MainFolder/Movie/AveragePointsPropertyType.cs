...
{
    public class AveragePointsPropertyType:IProperty
    {
        private static AveragePointsPropertyType _instance;
        public static AveragePointsPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AveragePointsPropertyType();
            }
            return _instance;
        }
        ...
        public AveragePointsPropertyType ()
        {
        }
        ...
        public string Name =>"AveragePoints";
        public ITypeBase DeclaringType => MovieEntityType.GetInstance();
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = Type.GetType("System.Double");
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = Type.GetType("System.Double");
                }
                return _clrType;
            }
        }
