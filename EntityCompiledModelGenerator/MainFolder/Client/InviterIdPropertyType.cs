...
{
    public class InviterIdPropertyType:IProperty
    {
        private static InviterIdPropertyType _instance;
        public static InviterIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InviterIdPropertyType();
            }
            return _instance;
        }
