...
{
    public class ClientPhotoIdPropertyType:IProperty
    {
        private static ClientPhotoIdPropertyType _instance;
        public static ClientPhotoIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ClientPhotoIdPropertyType();
            }
            return _instance;
        }
        ...
        public ClientPhotoIdPropertyType ()
        {
        }
        ...
        public string Name =>"ClientPhotoId";
