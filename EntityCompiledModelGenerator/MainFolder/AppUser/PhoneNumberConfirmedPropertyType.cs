...
{
    public class PhoneNumberConfirmedPropertyType:IProperty
    {
        private static PhoneNumberConfirmedPropertyType _instance;
        public static PhoneNumberConfirmedPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PhoneNumberConfirmedPropertyType();
            }
            return _instance;
        }
        ...
        public PhoneNumberConfirmedPropertyType ()
        {
        }
        ...
        public string Name =>"PhoneNumberConfirmed";
