...
{
    public class AdminNavigation:INavigation
    {
        private static AdminNavigation _instance;
        
        public static AdminNavigation GetInstance()
        {
            if(_instance==null)
            {
                _instance = new AdminNavigation();
            }
            return _instance;
        }
        ...
        public PropertyInfo PropertyInfo { 
            get
            {
                ...
                {
                    propertyInfo = ClrType.GetProperty("Admin");
                }
                return propertyInfo;
            } 
        }
        ...
        public FieldInfo FieldInfo { 
            get
            {
                if(fieldInfo==null)
                {
                    fieldInfo = ClrType.GetField("<Admin>k__BackingField");
                }
                return fieldInfo;
            }
        }
        ...
        public IForeignKey ForeignKey => AppUserAdminIdForeignKey.GetInstance();
