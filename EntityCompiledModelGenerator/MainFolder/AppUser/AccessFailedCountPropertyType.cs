...
{
    public class AccessFailedCountPropertyType:IProperty
    {
        private static AccessFailedCountPropertyType _instance;
        public static AccessFailedCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AccessFailedCountPropertyType();
            }
            return _instance;
        }
        ...
        public AccessFailedCountPropertyType ()
        {
        }
        ...
        public string Name =>"AccessFailedCount";
