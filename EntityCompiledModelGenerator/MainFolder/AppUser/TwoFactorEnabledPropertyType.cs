...
{
    public class TwoFactorEnabledPropertyType:IProperty
    {
        private static TwoFactorEnabledPropertyType _instance;
        public static TwoFactorEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TwoFactorEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public TwoFactorEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"TwoFactorEnabled";
