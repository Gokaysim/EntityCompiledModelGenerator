...
{
    public class NormalizedEmailPropertyType:IProperty
    {
        private static NormalizedEmailPropertyType _instance;
        public static NormalizedEmailPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new NormalizedEmailPropertyType();
            }
            return _instance;
        }
        ...
        public NormalizedEmailPropertyType ()
        {
        }
        ...
        public string Name =>"NormalizedEmail";
