...
{
    public class UserNamePropertyType:IProperty
    {
        private static UserNamePropertyType _instance;
        public static UserNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new UserNamePropertyType();
            }
            return _instance;
        }
