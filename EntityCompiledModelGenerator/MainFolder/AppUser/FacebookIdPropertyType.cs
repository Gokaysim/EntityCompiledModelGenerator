...
{
    public class FacebookIdPropertyType:IProperty
    {
        private static FacebookIdPropertyType _instance;
        public static FacebookIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new FacebookIdPropertyType();
            }
            return _instance;
        }
