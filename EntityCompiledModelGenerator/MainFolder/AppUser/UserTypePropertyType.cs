...
{
    public class UserTypePropertyType:IProperty
    {
        private static UserTypePropertyType _instance;
        public static UserTypePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new UserTypePropertyType();
            }
            return _instance;
        }
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.IdentityDBO.UserTypes);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.IdentityDBO.UserTypes);
                }
                return _clrType;
            }
        }
