...
{
    public class PasswordHashPropertyType:IProperty
    {
        private static PasswordHashPropertyType _instance;
        public static PasswordHashPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PasswordHashPropertyType();
            }
            return _instance;
        }
        ...
        public PasswordHashPropertyType ()
        {
        }
        ...
        public string Name =>"PasswordHash";
