...
{
    public class FirstNamePropertyType:IProperty
    {
        private static FirstNamePropertyType _instance;
        public static FirstNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new FirstNamePropertyType();
            }
            return _instance;
        }
