...
{
    public class EmailConfirmedPropertyType:IProperty
    {
        private static EmailConfirmedPropertyType _instance;
        public static EmailConfirmedPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EmailConfirmedPropertyType();
            }
            return _instance;
        }
        ...
        public EmailConfirmedPropertyType ()
        {
        }
        ...
        public string Name =>"EmailConfirmed";
