...
{
    public class NormalizedUserNamePropertyType:IProperty
    {
        private static NormalizedUserNamePropertyType _instance;
        public static NormalizedUserNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new NormalizedUserNamePropertyType();
            }
            return _instance;
        }
        ...
        public NormalizedUserNamePropertyType ()
        {
        }
        ...
        public string Name =>"NormalizedUserName";
