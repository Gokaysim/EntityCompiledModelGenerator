...
{
    public class SecurityStampPropertyType:IProperty
    {
        private static SecurityStampPropertyType _instance;
        public static SecurityStampPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new SecurityStampPropertyType();
            }
            return _instance;
        }
        ...
        public SecurityStampPropertyType ()
        {
        }
        ...
        public string Name =>"SecurityStamp";
