...
{
    public class LockoutEnabledPropertyType:IProperty
    {
        private static LockoutEnabledPropertyType _instance;
        public static LockoutEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LockoutEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public LockoutEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"LockoutEnabled";
