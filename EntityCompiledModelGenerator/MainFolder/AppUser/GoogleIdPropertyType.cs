...
{
    public class GoogleIdPropertyType:IProperty
    {
        private static GoogleIdPropertyType _instance;
        public static GoogleIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new GoogleIdPropertyType();
            }
            return _instance;
        }
