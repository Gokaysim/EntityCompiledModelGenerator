...
{
    public class MottoWorkerIdPropertyType:IProperty
    {
        private static MottoWorkerIdPropertyType _instance;
        public static MottoWorkerIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MottoWorkerIdPropertyType();
            }
            return _instance;
        }
        ...
        public MottoWorkerIdPropertyType ()
        {
        }
        ...
        public string Name =>"MottoWorkerId";
