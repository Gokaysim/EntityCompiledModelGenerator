...
{
    public class EmailPropertyType:IProperty
    {
        private static EmailPropertyType _instance;
        public static EmailPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EmailPropertyType();
            }
            return _instance;
        }
