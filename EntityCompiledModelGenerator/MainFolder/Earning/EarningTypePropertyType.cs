...
{
    public class EarningTypePropertyType:IProperty
    {
        private static EarningTypePropertyType _instance;
        public static EarningTypePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EarningTypePropertyType();
            }
            return _instance;
        }
        ...
        public EarningTypePropertyType ()
        {
        }
        ...
        public string Name =>"EarningType";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.EarningType);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.EarningType);
                }
                return _clrType;
            }
        }
