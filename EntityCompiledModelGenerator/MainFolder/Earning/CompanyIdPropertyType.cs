...
{
    public class CompanyIdPropertyType:IProperty
    {
        private static CompanyIdPropertyType _instance;
        public static CompanyIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CompanyIdPropertyType();
            }
            return _instance;
        }
