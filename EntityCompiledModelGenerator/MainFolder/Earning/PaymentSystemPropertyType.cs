...
{
    public class PaymentSystemPropertyType:IProperty
    {
        private static PaymentSystemPropertyType _instance;
        public static PaymentSystemPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PaymentSystemPropertyType();
            }
            return _instance;
        }
        ...
        public PaymentSystemPropertyType ()
        {
        }
        ...
        public string Name =>"PaymentSystem";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.PaymentSystem);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.PaymentSystem);
                }
                return _clrType;
            }
        }
