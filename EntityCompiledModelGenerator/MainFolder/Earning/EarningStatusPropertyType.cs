...
{
    public class EarningStatusPropertyType:IProperty
    {
        private static EarningStatusPropertyType _instance;
        public static EarningStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EarningStatusPropertyType();
            }
            return _instance;
        }
        ...
        public EarningStatusPropertyType ()
        {
        }
        ...
        public string Name =>"EarningStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.EarningStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.FinancialDBO.EarningStatus);
                }
                return _clrType;
            }
        }
