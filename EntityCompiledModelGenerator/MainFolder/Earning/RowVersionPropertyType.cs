...
{
    public class RowVersionPropertyType:IProperty
    {
        private static RowVersionPropertyType _instance;
        public static RowVersionPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new RowVersionPropertyType();
            }
            return _instance;
        }
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = Type.GetType("System.Byte[]");
               }
               return _clrType1;
           }
       }
        ...
        public PropertySaveBehavior BeforeSaveBehavior => PropertySaveBehavior.Ignore;
        public PropertySaveBehavior AfterSaveBehavior => PropertySaveBehavior.Ignore;
        public bool IsReadOnlyBeforeSave =>false;
        public bool IsReadOnlyAfterSave =>false;
        public bool IsStoreGeneratedAlways =>true;
        public ValueGenerated ValueGenerated =>ValueGenerated.OnAddOrUpdate;
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = Type.GetType("System.Byte[]");
                }
                return _clrType;
            }
        }
