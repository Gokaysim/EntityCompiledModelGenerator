...
{
    public class TotalPaymentPropertyType:IProperty
    {
        private static TotalPaymentPropertyType _instance;
        public static TotalPaymentPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TotalPaymentPropertyType();
            }
            return _instance;
        }
        ...
        public TotalPaymentPropertyType ()
        {
        }
        ...
        public string Name =>"TotalPayment";
