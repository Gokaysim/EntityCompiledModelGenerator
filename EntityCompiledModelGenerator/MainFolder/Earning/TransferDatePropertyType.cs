...
{
    public class TransferDatePropertyType:IProperty
    {
        private static TransferDatePropertyType _instance;
        public static TransferDatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TransferDatePropertyType();
            }
            return _instance;
        }
        ...
        public TransferDatePropertyType ()
        {
        }
        ...
        public string Name =>"TransferDate";
