...
{
    public class EarningIdPropertyType:IProperty
    {
        private static EarningIdPropertyType _instance;
        public static EarningIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EarningIdPropertyType();
            }
            return _instance;
        }
