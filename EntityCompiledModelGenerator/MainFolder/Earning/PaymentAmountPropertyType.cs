...
{
    public class PaymentAmountPropertyType:IProperty
    {
        private static PaymentAmountPropertyType _instance;
        public static PaymentAmountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PaymentAmountPropertyType();
            }
            return _instance;
        }
        ...
        public PaymentAmountPropertyType ()
        {
        }
        ...
        public string Name =>"PaymentAmount";
