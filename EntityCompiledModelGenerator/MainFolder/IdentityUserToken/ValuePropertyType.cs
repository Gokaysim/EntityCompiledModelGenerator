...
{
    public class ValuePropertyType:IProperty
    {
        private static ValuePropertyType _instance;
        public static ValuePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ValuePropertyType();
            }
            return _instance;
        }
