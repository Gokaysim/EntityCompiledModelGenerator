...
{
    public class LoginProviderPropertyType:IProperty
    {
        private static LoginProviderPropertyType _instance;
        public static LoginProviderPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LoginProviderPropertyType();
            }
            return _instance;
        }
        ...
        public LoginProviderPropertyType ()
        {
        }
        ...
        public string Name =>"LoginProvider";
        public ITypeBase DeclaringType => IdentityUserTokenEntityType.GetInstance();
