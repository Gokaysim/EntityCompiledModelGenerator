...
{
    public class ProviderKeyPropertyType:IProperty
    {
        private static ProviderKeyPropertyType _instance;
        public static ProviderKeyPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ProviderKeyPropertyType();
            }
            return _instance;
        }
        ...
        public ProviderKeyPropertyType ()
        {
        }
