...
{
    public class UpdateDatePropertyType:IProperty
    {
        private static UpdateDatePropertyType _instance;
        public static UpdateDatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new UpdateDatePropertyType();
            }
            return _instance;
        }
