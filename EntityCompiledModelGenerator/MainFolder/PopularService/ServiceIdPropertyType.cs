...
{
    public class ServiceIdPropertyType:IProperty
    {
        private static ServiceIdPropertyType _instance;
        public static ServiceIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ServiceIdPropertyType();
            }
            return _instance;
        }
