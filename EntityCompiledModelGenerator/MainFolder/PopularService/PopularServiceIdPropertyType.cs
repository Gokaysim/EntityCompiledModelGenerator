...
{
    public class PopularServiceIdPropertyType:IProperty
    {
        private static PopularServiceIdPropertyType _instance;
        public static PopularServiceIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PopularServiceIdPropertyType();
            }
            return _instance;
        }
        ...
        public PopularServiceIdPropertyType ()
        {
        }
        ...
        public string Name =>"PopularServiceId";
        public ITypeBase DeclaringType => PopularServiceEntityType.GetInstance();
