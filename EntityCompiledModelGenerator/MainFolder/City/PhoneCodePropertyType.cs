...
{
    public class PhoneCodePropertyType:IProperty
    {
        private static PhoneCodePropertyType _instance;
        public static PhoneCodePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PhoneCodePropertyType();
            }
            return _instance;
        }
