...
{
    public class CityIdPropertyType:IProperty
    {
        private static CityIdPropertyType _instance;
        public static CityIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CityIdPropertyType();
            }
            return _instance;
        }
