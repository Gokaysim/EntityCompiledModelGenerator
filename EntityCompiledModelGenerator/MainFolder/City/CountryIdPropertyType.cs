...
{
    public class CountryIdPropertyType:IProperty
    {
        private static CountryIdPropertyType _instance;
        public static CountryIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CountryIdPropertyType();
            }
            return _instance;
        }
