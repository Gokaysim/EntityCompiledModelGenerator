...
{
    public class PlateNumberPropertyType:IProperty
    {
        private static PlateNumberPropertyType _instance;
        public static PlateNumberPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PlateNumberPropertyType();
            }
            return _instance;
        }
        ...
        public PlateNumberPropertyType ()
        {
        }
        ...
        public string Name =>"PlateNumber";
