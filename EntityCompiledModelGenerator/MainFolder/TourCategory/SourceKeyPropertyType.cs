...
{
    public class SourceKeyPropertyType:IProperty
    {
        private static SourceKeyPropertyType _instance;
        public static SourceKeyPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new SourceKeyPropertyType();
            }
            return _instance;
        }
