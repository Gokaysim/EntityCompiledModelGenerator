...
{
    public class TourCategoryTourCategoryIdKey:IKey
    {    
        private static TourCategoryTourCategoryIdKey _instance;            
        public static TourCategoryTourCategoryIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new TourCategoryTourCategoryIdKey();
            }
            return _instance;
        }
