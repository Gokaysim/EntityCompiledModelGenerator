...
{
    public class ClaimTypePropertyType:IProperty
    {
        private static ClaimTypePropertyType _instance;
        public static ClaimTypePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ClaimTypePropertyType();
            }
            return _instance;
        }
        ...
        public string Name =>"ClaimType";
        public ITypeBase DeclaringType => IdentityUserClaimEntityType.GetInstance();
