...
{
    public class UserIdPropertyType:IProperty
    {
        private static UserIdPropertyType _instance;
        public static UserIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new UserIdPropertyType();
            }
            return _instance;
        }
