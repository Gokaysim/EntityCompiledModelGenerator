...
{
    public class ClaimValuePropertyType:IProperty
    {
        private static ClaimValuePropertyType _instance;
        public static ClaimValuePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ClaimValuePropertyType();
            }
            return _instance;
        }
