...
{
    public class ServiceStatusPropertyType:IProperty
    {
        private static ServiceStatusPropertyType _instance;
        public static ServiceStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ServiceStatusPropertyType();
            }
            return _instance;
        }
        ...
        public ServiceStatusPropertyType ()
        {
        }
        ...
        public string Name =>"ServiceStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.ServiceDBO.ServiceStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.ServiceDBO.ServiceStatus);
                }
                return _clrType;
            }
        }
