...
{
    public class RateCountPropertyType:IProperty
    {
        private static RateCountPropertyType _instance;
        public static RateCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new RateCountPropertyType();
            }
            return _instance;
        }
