...
{
    public class AvgRatingPropertyType:IProperty
    {
        private static AvgRatingPropertyType _instance;
        public static AvgRatingPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AvgRatingPropertyType();
            }
            return _instance;
        }
