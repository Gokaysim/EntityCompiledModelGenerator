...
{
    public class CommissionRatePropertyType:IProperty
    {
        private static CommissionRatePropertyType _instance;
        public static CommissionRatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new CommissionRatePropertyType();
            }
            return _instance;
        }
        ...
        public CommissionRatePropertyType ()
        {
        }
        ...
        public string Name =>"CommissionRate";
