...
{
    public class AdultPricePropertyType:IProperty
    {
        private static AdultPricePropertyType _instance;
        public static AdultPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultPricePropertyType();
            }
            return _instance;
        }
