...
{
    public class InfantCountPropertyType:IProperty
    {
        private static InfantCountPropertyType _instance;
        public static InfantCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InfantCountPropertyType();
            }
            return _instance;
        }
        ...
        public InfantCountPropertyType ()
        {
        }
        ...
        public string Name =>"InfantCount";
