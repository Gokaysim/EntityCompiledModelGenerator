...
{
    public class AdultManPricePropertyType:IProperty
    {
        private static AdultManPricePropertyType _instance;
        public static AdultManPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultManPricePropertyType();
            }
            return _instance;
        }
        ...
        public AdultManPricePropertyType ()
        {
        }
        ...
        public string Name =>"AdultManPrice";
