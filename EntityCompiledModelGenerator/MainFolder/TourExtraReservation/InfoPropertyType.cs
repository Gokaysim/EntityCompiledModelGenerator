...
{
    public class InfoPropertyType:IProperty
    {
        private static InfoPropertyType _instance;
        public static InfoPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InfoPropertyType();
            }
            return _instance;
        }
