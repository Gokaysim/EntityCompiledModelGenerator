...
{
  public class TourReservationIdIndex : IIndex
  {
  
    private static TourReservationIdIndex _instance;
    
    public static TourReservationIdIndex GetInstance()
    {
        if(_instance==null)
        {
            _instance = new TourReservationIdIndex();
        }
        return _instance;
    }
