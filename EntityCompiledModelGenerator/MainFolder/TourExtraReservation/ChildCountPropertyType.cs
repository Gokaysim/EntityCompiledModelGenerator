...
{
    public class ChildCountPropertyType:IProperty
    {
        private static ChildCountPropertyType _instance;
        public static ChildCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ChildCountPropertyType();
            }
            return _instance;
        }
