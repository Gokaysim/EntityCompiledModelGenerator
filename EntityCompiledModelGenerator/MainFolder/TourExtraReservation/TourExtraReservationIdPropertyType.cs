...
{
    public class TourExtraReservationIdPropertyType:IProperty
    {
        private static TourExtraReservationIdPropertyType _instance;
        public static TourExtraReservationIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourExtraReservationIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourExtraReservationIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourExtraReservationId";
