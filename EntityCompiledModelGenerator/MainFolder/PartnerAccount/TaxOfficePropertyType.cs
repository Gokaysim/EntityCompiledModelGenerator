...
{
    public class TaxOfficePropertyType:IProperty
    {
        private static TaxOfficePropertyType _instance;
        public static TaxOfficePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TaxOfficePropertyType();
            }
            return _instance;
        }
