...
{
    public class LegalNamePropertyType:IProperty
    {
        private static LegalNamePropertyType _instance;
        public static LegalNamePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LegalNamePropertyType();
            }
            return _instance;
        }
