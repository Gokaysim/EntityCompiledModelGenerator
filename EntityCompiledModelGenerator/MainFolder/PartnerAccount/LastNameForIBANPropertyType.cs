...
{
    public class LastNameForIBANPropertyType:IProperty
    {
        private static LastNameForIBANPropertyType _instance;
        public static LastNameForIBANPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LastNameForIBANPropertyType();
            }
            return _instance;
        }
        ...
        public LastNameForIBANPropertyType ()
        {
        }
        ...
        public string Name =>"LastNameForIBAN";
