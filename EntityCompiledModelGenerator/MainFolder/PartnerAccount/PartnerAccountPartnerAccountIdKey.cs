...
{
    public class PartnerAccountPartnerAccountIdKey:IKey
    {    
        private static PartnerAccountPartnerAccountIdKey _instance;            
        public static PartnerAccountPartnerAccountIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new PartnerAccountPartnerAccountIdKey();
            }
            return _instance;
        }
