...
{
    public class EInvoicePropertyType:IProperty
    {
        private static EInvoicePropertyType _instance;
        public static EInvoicePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new EInvoicePropertyType();
            }
            return _instance;
        }
