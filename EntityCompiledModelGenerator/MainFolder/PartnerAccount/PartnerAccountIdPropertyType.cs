...
{
    public class PartnerAccountIdPropertyType:IProperty
    {
        private static PartnerAccountIdPropertyType _instance;
        public static PartnerAccountIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PartnerAccountIdPropertyType();
            }
            return _instance;
        }
        ...
        public PartnerAccountIdPropertyType ()
        {
        }
        ...
        public string Name =>"PartnerAccountId";
