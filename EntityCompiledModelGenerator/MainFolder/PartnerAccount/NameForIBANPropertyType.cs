...
{
    public class NameForIBANPropertyType:IProperty
    {
        private static NameForIBANPropertyType _instance;
        public static NameForIBANPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new NameForIBANPropertyType();
            }
            return _instance;
        }
        ...
        public NameForIBANPropertyType ()
        {
        }
        ...
        public string Name =>"NameForIBAN";
