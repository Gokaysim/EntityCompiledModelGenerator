...
{
    public class SubcategoryTourMatchTourCategoryIdTourIdKey:IKey
    {    
        private static SubcategoryTourMatchTourCategoryIdTourIdKey _instance;            
        public static SubcategoryTourMatchTourCategoryIdTourIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new SubcategoryTourMatchTourCategoryIdTourIdKey();
            }
            return _instance;
        }
