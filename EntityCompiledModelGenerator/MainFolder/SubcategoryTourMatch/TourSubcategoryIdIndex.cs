...
{
  public class TourSubcategoryIdIndex : IIndex
  {
  
    private static TourSubcategoryIdIndex _instance;
    
    public static TourSubcategoryIdIndex GetInstance()
    {
        if(_instance==null)
        {
            _instance = new TourSubcategoryIdIndex();
        }
        return _instance;
    }
