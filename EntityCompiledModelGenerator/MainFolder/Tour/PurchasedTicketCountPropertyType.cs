...
{
    public class PurchasedTicketCountPropertyType:IProperty
    {
        private static PurchasedTicketCountPropertyType _instance;
        public static PurchasedTicketCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PurchasedTicketCountPropertyType();
            }
            return _instance;
        }
        ...
        public PurchasedTicketCountPropertyType ()
        {
        }
        ...
        public string Name =>"PurchasedTicketCount";
