...
{
    public class LastReservationHoursBeforeServiceTimePropertyType:IProperty
    {
        private static LastReservationHoursBeforeServiceTimePropertyType _instance;
        public static LastReservationHoursBeforeServiceTimePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LastReservationHoursBeforeServiceTimePropertyType();
            }
            return _instance;
        }
        ...
        public LastReservationHoursBeforeServiceTimePropertyType ()
        {
        }
        ...
        public string Name =>"LastReservationHoursBeforeServiceTime";
