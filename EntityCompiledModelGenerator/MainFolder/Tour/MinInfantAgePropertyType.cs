...
{
    public class MinInfantAgePropertyType:IProperty
    {
        private static MinInfantAgePropertyType _instance;
        public static MinInfantAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MinInfantAgePropertyType();
            }
            return _instance;
        }
        ...
        public MinInfantAgePropertyType ()
        {
        }
        ...
        public string Name =>"MinInfantAge";
