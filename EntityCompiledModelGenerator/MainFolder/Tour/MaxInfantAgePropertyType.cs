...
{
    public class MaxInfantAgePropertyType:IProperty
    {
        private static MaxInfantAgePropertyType _instance;
        public static MaxInfantAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MaxInfantAgePropertyType();
            }
            return _instance;
        }
        ...
        public MaxInfantAgePropertyType ()
        {
        }
        ...
        public string Name =>"MaxInfantAge";
