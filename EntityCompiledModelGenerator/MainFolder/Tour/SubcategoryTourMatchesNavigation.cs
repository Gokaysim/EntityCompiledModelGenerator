    ...
    public class SubcategoryTourMatchesNavigation:INavigation
    {
        ...
        public Type ClrType { 
            get
            {
                if(clrType==null)
                {
                    clrType = Type.GetType("System.Collections.Generic.ICollection`1[[Mottojoy.Infrastructure.Entity.TourDBO.SubcategoryTourMatch, Mottojoy.Infrastructure.Entity, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]");
                }
                return clrType;
            } 
        }
        ...
        public IForeignKey ForeignKey => SubcategoryTourMatchTourIdForeignKey.GetInstance();
