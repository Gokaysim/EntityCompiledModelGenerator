...
{
    public class DatePropertyType:IProperty
    {
        private static DatePropertyType _instance;
        public static DatePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new DatePropertyType();
            }
            return _instance;
        }
