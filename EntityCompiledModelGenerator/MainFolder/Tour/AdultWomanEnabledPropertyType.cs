...
{
    public class AdultWomanEnabledPropertyType:IProperty
    {
        private static AdultWomanEnabledPropertyType _instance;
        public static AdultWomanEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultWomanEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public AdultWomanEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"AdultWomanEnabled";
