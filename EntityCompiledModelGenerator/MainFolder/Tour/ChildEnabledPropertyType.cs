...
{
    public class ChildEnabledPropertyType:IProperty
    {
        private static ChildEnabledPropertyType _instance;
        public static ChildEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ChildEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public ChildEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"ChildEnabled";
