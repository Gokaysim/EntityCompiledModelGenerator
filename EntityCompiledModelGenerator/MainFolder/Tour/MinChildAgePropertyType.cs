...
{
    public class MinChildAgePropertyType:IProperty
    {
        private static MinChildAgePropertyType _instance;
        public static MinChildAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MinChildAgePropertyType();
            }
            return _instance;
        }
        ...
        public MinChildAgePropertyType ()
        {
        }
        ...
        public string Name =>"MinChildAge";
