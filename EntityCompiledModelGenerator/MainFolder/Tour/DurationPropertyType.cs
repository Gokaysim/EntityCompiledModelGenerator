...
{
    public class DurationPropertyType:IProperty
    {
        private static DurationPropertyType _instance;
        public static DurationPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new DurationPropertyType();
            }
            return _instance;
        }
