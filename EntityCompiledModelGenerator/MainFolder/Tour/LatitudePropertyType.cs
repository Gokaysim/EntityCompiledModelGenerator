...
{
    public class LatitudePropertyType:IProperty
    {
        private static LatitudePropertyType _instance;
        public static LatitudePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LatitudePropertyType();
            }
            return _instance;
        }
