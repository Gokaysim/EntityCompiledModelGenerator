...
{
    public class MaxChildAgePropertyType:IProperty
    {
        private static MaxChildAgePropertyType _instance;
        public static MaxChildAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MaxChildAgePropertyType();
            }
            return _instance;
        }
        ...
        public MaxChildAgePropertyType ()
        {
        }
        ...
        public string Name =>"MaxChildAge";
