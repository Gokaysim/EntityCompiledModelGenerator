...
{
    public class MinAdultAgePropertyType:IProperty
    {
        private static MinAdultAgePropertyType _instance;
        public static MinAdultAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MinAdultAgePropertyType();
            }
            return _instance;
        }
        ...
        public MinAdultAgePropertyType ()
        {
        }
        ...
        public string Name =>"MinAdultAge";
