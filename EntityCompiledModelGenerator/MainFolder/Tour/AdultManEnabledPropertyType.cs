...
{
    public class AdultManEnabledPropertyType:IProperty
    {
        private static AdultManEnabledPropertyType _instance;
        public static AdultManEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultManEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public AdultManEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"AdultManEnabled";
