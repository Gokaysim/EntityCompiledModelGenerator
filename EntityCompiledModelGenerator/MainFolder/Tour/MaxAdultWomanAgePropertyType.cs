...
{
    public class MaxAdultWomanAgePropertyType:IProperty
    {
        private static MaxAdultWomanAgePropertyType _instance;
        public static MaxAdultWomanAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MaxAdultWomanAgePropertyType();
            }
            return _instance;
        }
        ...
        public MaxAdultWomanAgePropertyType ()
        {
        }
        ...
        public string Name =>"MaxAdultWomanAge";
