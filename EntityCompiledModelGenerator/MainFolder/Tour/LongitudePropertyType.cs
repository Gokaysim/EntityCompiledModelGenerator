...
{
    public class LongitudePropertyType:IProperty
    {
        private static LongitudePropertyType _instance;
        public static LongitudePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LongitudePropertyType();
            }
            return _instance;
        }
