...
{
    public class LastPurchaseHoursBeforeServiceTimePropertyType:IProperty
    {
        private static LastPurchaseHoursBeforeServiceTimePropertyType _instance;
        public static LastPurchaseHoursBeforeServiceTimePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new LastPurchaseHoursBeforeServiceTimePropertyType();
            }
            return _instance;
        }
        ...
        public LastPurchaseHoursBeforeServiceTimePropertyType ()
        {
        }
        ...
        public string Name =>"LastPurchaseHoursBeforeServiceTime";
