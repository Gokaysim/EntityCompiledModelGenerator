...
{
    public class TourStatusPropertyType:IProperty
    {
        private static TourStatusPropertyType _instance;
        public static TourStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourStatusPropertyType();
            }
            return _instance;
        }
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.TourDBO.TourStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.TourDBO.TourStatus);
                }
                return _clrType;
            }
        }
