...
{
    public class MaxAdultAgePropertyType:IProperty
    {
        private static MaxAdultAgePropertyType _instance;
        public static MaxAdultAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MaxAdultAgePropertyType();
            }
            return _instance;
        }
        ...
        public MaxAdultAgePropertyType ()
        {
        }
        ...
        public string Name =>"MaxAdultAge";
