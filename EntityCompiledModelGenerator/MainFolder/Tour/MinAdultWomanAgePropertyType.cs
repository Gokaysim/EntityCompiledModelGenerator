...
{
    public class MinAdultWomanAgePropertyType:IProperty
    {
        private static MinAdultWomanAgePropertyType _instance;
        public static MinAdultWomanAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MinAdultWomanAgePropertyType();
            }
            return _instance;
        }
        ...
        public MinAdultWomanAgePropertyType ()
        {
        }
        ...
        public string Name =>"MinAdultWomanAge";
