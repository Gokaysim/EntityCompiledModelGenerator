...
{
    public class MaxAdultManAgePropertyType:IProperty
    {
        private static MaxAdultManAgePropertyType _instance;
        public static MaxAdultManAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MaxAdultManAgePropertyType();
            }
            return _instance;
        }
        ...
        public MaxAdultManAgePropertyType ()
        {
        }
        ...
        public string Name =>"MaxAdultManAge";
