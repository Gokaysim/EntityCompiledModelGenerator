...
{
    public class MinAdultManAgePropertyType:IProperty
    {
        private static MinAdultManAgePropertyType _instance;
        public static MinAdultManAgePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new MinAdultManAgePropertyType();
            }
            return _instance;
        }
        ...
        public MinAdultManAgePropertyType ()
        {
        }
        ...
        public string Name =>"MinAdultManAge";
