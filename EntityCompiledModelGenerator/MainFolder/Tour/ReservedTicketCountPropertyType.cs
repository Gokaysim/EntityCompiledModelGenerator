...
{
    public class ReservedTicketCountPropertyType:IProperty
    {
        private static ReservedTicketCountPropertyType _instance;
        public static ReservedTicketCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ReservedTicketCountPropertyType();
            }
            return _instance;
        }
        ...
        public ReservedTicketCountPropertyType ()
        {
        }
        ...
        public string Name =>"ReservedTicketCount";
