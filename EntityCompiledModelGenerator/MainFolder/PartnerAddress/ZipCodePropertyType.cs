...
{
    public class ZipCodePropertyType:IProperty
    {
        private static ZipCodePropertyType _instance;
        public static ZipCodePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ZipCodePropertyType();
            }
            return _instance;
        }
