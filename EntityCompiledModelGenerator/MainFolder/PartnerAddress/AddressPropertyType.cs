...
{
    public class AddressPropertyType:IProperty
    {
        private static AddressPropertyType _instance;
        public static AddressPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AddressPropertyType();
            }
            return _instance;
        }
