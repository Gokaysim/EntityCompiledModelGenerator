...
{
    public class TourCategoryDetailTourCategoryIdCultureKey:IKey
    {    
        private static TourCategoryDetailTourCategoryIdCultureKey _instance;            
        public static TourCategoryDetailTourCategoryIdCultureKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new TourCategoryDetailTourCategoryIdCultureKey();
            }
            return _instance;
        }
