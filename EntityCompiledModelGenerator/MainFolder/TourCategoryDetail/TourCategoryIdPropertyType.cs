...
{
    public class TourCategoryIdPropertyType:IProperty
    {
        private static TourCategoryIdPropertyType _instance;
        public static TourCategoryIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourCategoryIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourCategoryIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourCategoryId";
