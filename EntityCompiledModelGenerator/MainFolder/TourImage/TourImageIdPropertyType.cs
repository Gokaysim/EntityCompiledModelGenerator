...
{
    public class TourImageIdPropertyType:IProperty
    {
        private static TourImageIdPropertyType _instance;
        public static TourImageIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourImageIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourImageIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourImageId";
