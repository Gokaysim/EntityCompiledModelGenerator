...
{
    public class TourBarImageTourIdPropertyType:IProperty
    {
        private static TourBarImageTourIdPropertyType _instance;
        public static TourBarImageTourIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourBarImageTourIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourBarImageTourIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourBarImageTourId";
