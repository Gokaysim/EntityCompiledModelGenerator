...
{
  public class FeaturedImageTourIdIndex : IIndex
  {
  
    private static FeaturedImageTourIdIndex _instance;
    
    public static FeaturedImageTourIdIndex GetInstance()
    {
        if(_instance==null)
        {
            _instance = new FeaturedImageTourIdIndex();
        }
        return _instance;
    }
