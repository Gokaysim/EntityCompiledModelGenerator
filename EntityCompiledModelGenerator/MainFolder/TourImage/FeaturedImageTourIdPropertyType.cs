...
{
    public class FeaturedImageTourIdPropertyType:IProperty
    {
        private static FeaturedImageTourIdPropertyType _instance;
        public static FeaturedImageTourIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new FeaturedImageTourIdPropertyType();
            }
            return _instance;
        }
        ...
        public FeaturedImageTourIdPropertyType ()
        {
        }
        ...
        public string Name =>"FeaturedImageTourId";
