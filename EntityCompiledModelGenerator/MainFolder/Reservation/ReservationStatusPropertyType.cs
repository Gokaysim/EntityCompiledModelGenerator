...
{
    public class ReservationStatusPropertyType:IProperty
    {
        private static ReservationStatusPropertyType _instance;
        public static ReservationStatusPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ReservationStatusPropertyType();
            }
            return _instance;
        }
        ...
        public ReservationStatusPropertyType ()
        {
        }
        ...
        public string Name =>"ReservationStatus";
        ...
        Type IProperty.ClrType  
        {
           get{
               if(_clrType1==null)
               {
                   _clrType1 = typeof(Mottojoy.Infrastructure.Entity.ReservationDBO.ReservationStatus);
               }
               return _clrType1;
           }
       }
        ...
        Type IPropertyBase.ClrType{
            get{
                if(_clrType==null)
                {
                    _clrType = typeof(Mottojoy.Infrastructure.Entity.ReservationDBO.ReservationStatus);
                }
                return _clrType;
            }
        }
