...
{
    public class PhoneNumberPropertyType:IProperty
    {
        private static PhoneNumberPropertyType _instance;
        public static PhoneNumberPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PhoneNumberPropertyType();
            }
            return _instance;
        }
        ...
        public PhoneNumberPropertyType ()
        {
        }
