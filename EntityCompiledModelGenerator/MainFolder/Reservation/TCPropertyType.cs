...
{
    public class TCPropertyType:IProperty
    {
        private static TCPropertyType _instance;
        public static TCPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TCPropertyType();
            }
            return _instance;
        }
