...
{
    public class TotalPricePropertyType:IProperty
    {
        private static TotalPricePropertyType _instance;
        public static TotalPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TotalPricePropertyType();
            }
            return _instance;
        }
