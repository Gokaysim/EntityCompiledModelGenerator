...
{
    public class InfantEnabledPropertyType:IProperty
    {
        private static InfantEnabledPropertyType _instance;
        public static InfantEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InfantEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public InfantEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"InfantEnabled";
