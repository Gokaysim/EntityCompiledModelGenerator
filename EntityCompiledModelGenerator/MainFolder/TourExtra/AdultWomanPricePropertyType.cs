...
{
    public class AdultWomanPricePropertyType:IProperty
    {
        private static AdultWomanPricePropertyType _instance;
        public static AdultWomanPricePropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultWomanPricePropertyType();
            }
            return _instance;
        }
        ...
        public AdultWomanPricePropertyType ()
        {
        }
        ...
        public string Name =>"AdultWomanPrice";
