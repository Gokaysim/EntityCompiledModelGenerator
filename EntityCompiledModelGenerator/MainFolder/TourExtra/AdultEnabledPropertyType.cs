...
{
    public class AdultEnabledPropertyType:IProperty
    {
        private static AdultEnabledPropertyType _instance;
        public static AdultEnabledPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new AdultEnabledPropertyType();
            }
            return _instance;
        }
        ...
        public AdultEnabledPropertyType ()
        {
        }
        ...
        public string Name =>"AdultEnabled";
