...
{
    public class InfoIsNeededPropertyType:IProperty
    {
        private static InfoIsNeededPropertyType _instance;
        public static InfoIsNeededPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new InfoIsNeededPropertyType();
            }
            return _instance;
        }
        ...
        public InfoIsNeededPropertyType ()
        {
        }
        ...
        public string Name =>"InfoIsNeeded";
