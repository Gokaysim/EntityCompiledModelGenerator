...
{
    public class TicketCountPropertyType:IProperty
    {
        private static TicketCountPropertyType _instance;
        public static TicketCountPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TicketCountPropertyType();
            }
            return _instance;
        }
        ...
        public TicketCountPropertyType ()
        {
        }
        ...
        public string Name =>"TicketCount";
