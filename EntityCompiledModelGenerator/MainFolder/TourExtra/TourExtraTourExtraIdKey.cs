...
{
    public class TourExtraTourExtraIdKey:IKey
    {    
        private static TourExtraTourExtraIdKey _instance;            
        public static TourExtraTourExtraIdKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new TourExtraTourExtraIdKey();
            }
            return _instance;
        }
