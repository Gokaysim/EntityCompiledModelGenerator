...
{
    public class OpenAddressPropertyType:IProperty
    {
        private static OpenAddressPropertyType _instance;
        public static OpenAddressPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new OpenAddressPropertyType();
            }
            return _instance;
        }
        ...
        public OpenAddressPropertyType ()
        {
        }
        ...
        public string Name =>"OpenAddress";
