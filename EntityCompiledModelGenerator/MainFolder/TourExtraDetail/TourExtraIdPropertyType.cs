...
{
    public class TourExtraIdPropertyType:IProperty
    {
        private static TourExtraIdPropertyType _instance;
        public static TourExtraIdPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new TourExtraIdPropertyType();
            }
            return _instance;
        }
        ...
        public TourExtraIdPropertyType ()
        {
        }
        ...
        public string Name =>"TourExtraId";
