...
{
    public class TourExtraDetailTourExtraIdCultureKey:IKey
    {    
        private static TourExtraDetailTourExtraIdCultureKey _instance;            
        public static TourExtraDetailTourExtraIdCultureKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new TourExtraDetailTourExtraIdCultureKey();
            }
            return _instance;
        }
