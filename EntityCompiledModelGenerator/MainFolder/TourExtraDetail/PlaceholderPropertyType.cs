...
{
    public class PlaceholderPropertyType:IProperty
    {
        private static PlaceholderPropertyType _instance;
        public static PlaceholderPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new PlaceholderPropertyType();
            }
            return _instance;
        }
