...
{
    public class TourDetailTourIdCultureKey:IKey
    {    
        private static TourDetailTourIdCultureKey _instance;            
        public static TourDetailTourIdCultureKey GetInstance()
        {
            if(_instance==null)
            {
                _instance = new TourDetailTourIdCultureKey();
            }
            return _instance;
        }
