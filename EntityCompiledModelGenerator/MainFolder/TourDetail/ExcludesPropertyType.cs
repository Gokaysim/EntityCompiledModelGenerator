...
{
    public class ExcludesPropertyType:IProperty
    {
        private static ExcludesPropertyType _instance;
        public static ExcludesPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new ExcludesPropertyType();
            }
            return _instance;
        }
