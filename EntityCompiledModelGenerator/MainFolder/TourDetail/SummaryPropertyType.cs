...
{
    public class SummaryPropertyType:IProperty
    {
        private static SummaryPropertyType _instance;
        public static SummaryPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new SummaryPropertyType();
            }
            return _instance;
        }
