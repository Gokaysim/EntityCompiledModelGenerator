...
{
    public class IncludesPropertyType:IProperty
    {
        private static IncludesPropertyType _instance;
        public static IncludesPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new IncludesPropertyType();
            }
            return _instance;
        }
