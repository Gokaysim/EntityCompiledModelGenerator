...
{
    public class FullDescriptionPropertyType:IProperty
    {
        private static FullDescriptionPropertyType _instance;
        public static FullDescriptionPropertyType GetInstance()
        {
            if(_instance==null)
            {
                _instance =  new FullDescriptionPropertyType();
            }
            return _instance;
        }
        ...
        public FullDescriptionPropertyType ()
        {
        }
        ...
        public string Name =>"FullDescription";
        public ITypeBase DeclaringType => TourDetailEntityType.GetInstance();
